...
import { VITAL_SUCCESS, VITAL_ERROR, APPOINTMENT_ERROR, GET_VITALS } from './types';
...
export const createVitalReport = (formData) => async (dispatch) => {
  try {
    const config = {
    ...
    dispatch(alert('VITAL SUBMITTED'));
  } catch (err) {
    const errors = 'error';
