...
import { MainLayout, EnterVitals } from '../../components/common';
...
const PatientDetails = ( props) => {
  return (
    <>
      {/* <MainLayout> */}
      <div className="flex flex-col flex-grow pl-16 pr-8 pt-20 mb-10 bg-gray-100 h-full">
            ...
            <div className="flex justify-center w-full p-10 ">
              ...
              <div className="flex flex-1">
                <div className="main_one flex flex-1 flex-col text-right">
                  ...
                  <div className="mb-8">
                    {/* <small>Marital Status</small>
                <h3 className="font-semibold">{props.user.maritalStatus}</h3> */}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col p-10 w-96 h-80 bg-white border rounded-3xl mr-8 ">
            ...
            <div className="main_one flex justify-between">
              <div className="mt-8">
                <small>Date</small>
                <h3 className="font-semibold">
                  {/* {props.user.appointment.appointmentTime} 21th April, 2021 */}
                </h3>
              </div>
              <div className="mt-8">
                <small>Time</small>
                <h3 className="font-semibold">
                  {/* {props.user.appointment[0].appointmentTime} */} 10am
                </h3>
              </div>
            </div>
            <div className="main_one flex justify-between">
              <div className="mt-8">
                <small>Concern</small>
                <h3 className="font-semibold">
                  {/* {props.user.appointment[0].concern} */} fever
                </h3>
              </div>
              <div className="mt-8">
